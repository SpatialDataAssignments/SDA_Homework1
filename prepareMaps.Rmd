...
africaLink="https://github.com/SpatialDataAssignments/SDA_Homework1/raw/refs/heads/main/europe_8857.gpkg"
library(sf)
...
```{r, message=FALSE}
europe <- st_read(africaLink, layer = "continent")
europeMobi_ddm <- st_read(africaLink, layer = "mobiles_ddm")
europeMobi_psm <- st_read(africaLink, layer = "mobiles_psm")
